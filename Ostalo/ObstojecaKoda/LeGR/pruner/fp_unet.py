...
from model.unet import Down, Up
...
class FilterPrunerUNet(FilterPruner):
    ...
    def parse_dependency(self):
        ...
        for m in self.model.modules():
            ...
            if isinstance(m, (Down, Up)):
                cur_conv_idx = self.conv_to_index[m.conv.conv2] # last convolution in block

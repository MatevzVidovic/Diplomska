...
argparser.add_argument('--sp', help='Starting path e.g. scp_copy_0/unet_prune_ipad', required=True, type=str, default="unet_prune_ipad_new")
argparser.add_argument('-m', help='Models. [(train_iter, uniq_id),...] e.g. "[(1, \"ending_save\"), (80, \"\")]" ', required=True, type=models_handler)
argparser.add_argument('--mn', help='model name. e.g. SegNet', required=True, type=str, default="UNet")
argparser.add_argument('--fid', help='Folder ID. e.g. "_uniform"', required=True, type=str, default="_IPAD")
argparser.add_argument('--main', help='main.py. e.g. segnet_main.py', required=True, type=str, default="unet_original_pruning_.py")

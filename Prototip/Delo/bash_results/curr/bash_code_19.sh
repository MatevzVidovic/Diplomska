...
# python3 main.py --ips 0 --sd UNet  -t < "$save_and_stop"           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))


# python3 main.py --ips 999999 --bs 4 --nodw 10 --sd UNet --ptd ./sclera_data -t --mti 2           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
# python3 main.py --ips 0 --sd UNet  -t < "$save_and_stop"           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))


# python3 main.py --ips 999999 --bs 4 --nodw 10 --ntibp 2 --sd UNet --ptd ./sclera_data -t --pruning_phase --pbop --map 2 --pnkao 50 --rn flops_num --ptp 0.005           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
# python3 main.py --ips 0 --sd UNet  -t < "$save_and_stop"           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
...
# python3 main.py --ips 999999 --bs 4 --nodw 10 --ntibp 2 --sd UNet --ptd ./vein_sclera_data -t --pruning_phase --pbop --map 2 --pnkao 50 --rn flops_num --ptp 0.005           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
# python3 main.py --ips 0 --sd UNet  -t < "$save_and_stop"           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
...
# python3 main.py --ips 999999 --bs 4 --nodw 10 --sd UNet --ptd ./vein_sclera_data -t --mti 2           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
# python3 main.py --ips 0 --sd UNet  -t < "$save_and_stop"           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
...
python3 main.py --tp  --ips 999999 --bs 4 --nodw 10 --ntibp 2 --sd UNet --ptd ./vein_sclera_data -t --pruning_phase --pbop --map 2 --pnkao 50 --rn flops_num --ptp 0.05           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
python3 main.py --ips 0 --sd UNet  -t < "$save_and_stop"           2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))
...
# python3 main.py 999999 4 10 1 UNet ./sclera_data --mti 20          2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))

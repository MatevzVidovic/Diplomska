...
python3 ${main_name} --ips 999999 --bs ${bs} --nodw ${nodw} --ntibp 1 --sd ${folder_name} --ptd ${ptd} --mti 100 --lr ${lr} --optim Adam --loss_fn_name MCDL --tesl ${tesl} --iw ${iw} --ih ${ih} --ds ${ds} -m ${model_name}            2>&1 | tee "${rfn}/curr/${obn}_${cbi}_${cn}.txt"; cn=$((cn + 1))

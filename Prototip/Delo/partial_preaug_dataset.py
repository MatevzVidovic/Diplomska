...
from img_and_fig_tools import smart_conversion, show_image, save_img_quick_figs
...
def zoom_in_somewhere(img, mask, max_scale_percent=0.2, prob=0.2):
    ...
    offset_vert = np.random.randint(0, max_offset_vert)
    offset_horiz = np.random.randint(0, max_offset_horiz)
